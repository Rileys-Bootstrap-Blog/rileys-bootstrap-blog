...
function genTip() {
    ...
    document.getElementById('tip').innerHTML = tips[randNum];
}

//tip array
var tips =
    ["Filler",
     "To get to the home page from a post with the keyboard on Microsoft Windows, press ALT and H together.",
     "On posts highlight text to share it on Facebook.",
     "Want to share a post but don't see your favorite sharing site? Click the blue crown button at the bottom right and find it there.",
...
var announcements = ["Filler",
                    ...
                    "8 temples announced by President Nelson, plus renovations of all Pioneer-era temples. Pago Pago, American Samoa Okinawa City Neiafu Tonga Tooele Valley Utah Moses Lake Washington San Pedrosula Honduras Antofagasta, Chile Budapest, Hungary",];


//GC quote generator
function confQuote() {
    var randNum = Math.floor(Math.random() * 89) + 1;
...
var quotes = ["Filler",
             ...
             "Elder @StevensonGaryE on the #latterdaysaint athletes: \"I found it interesting that they do not identify themselves by what they do, as professional athletes, rather by who they are, as sons of a loving Heavenly Father and holders of the priesthood of God.\"",
